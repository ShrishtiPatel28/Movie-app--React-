...
const DetailsPeople = ({ actors }) => {
  ...
  return (
    <div className="details-container relative w-full relative h-auto px-5 text-white">
      <Button />
      <div className="w-full h-auto flex flex-col md:flex-row justify-left gap-8 absolute left-[50px]">
        {/* Left Section: Actor's Photo & Personal Info */}
        <div className="left flex flex-col items-center md:items-start md:w-1/3 font-bold text-sm">
          <img
            src={peopledetails.photo}
            className="w-[300px] h-[400px] ml-[30px] mt-5 opacity-85 object-cover p-4"
          />
          <div className="w-[80%] h-auto ml-[48px] mt-4 border-t-2 border-zinc-600">
            <h1 className="text-[23px] ml-2 font-extrabold text-neutral-500 mt-4">
              Personal Info
            </h1>
            <h2 className="text-neutral-500 ml-2 text-[16px] font-bold mt-4 mb-4">
          ...
          <div className="w-[80%] ml-[48px] border-t-2 border-zinc-600">
            ...
            <div className="flex flex-row ml-2 gap-4 mt-5">
              <i className="ri-instagram-line text-[25px] text-neutral-500"></i>
              <i className="ri-facebook-box-fill text-[25px] text-neutral-500"></i>
              <i className="ri-threads-fill text-[25px] text-neutral-500"></i>
            </div>
          </div>
        </div>

        {/* Right Section: Actor's Details, Biography, Achievements */}
        <div className="right w-full md:w-2/3">
          <h1 className="text-4xl md:text-6xl font-black text-neutral-500 mt-6">
            {peopledetails.name}
          </h1>
          ...
          <p className="bio">
            ...
            <p className="text-neutral-500 mt-2 text-[15px] px-1 font-normal w-full md:w-[890px]">
              {peopledetails.biography}
            </p>
          </p>
          ...
          <p className="awards">
            ...
            <ul className="text-neutral-500 mt-1 text-[16px] px-1 font-normal w-full md:w-[900px]">
              {peopledetails.career_overview.major_achievements.map(
                (achievement, index) => (
                  <li
                    key={index}
          ...
          <div className="w-full flex flex-col md:flex-row gap-8 mt-4 ">
            <p className="roles w-full md:w-1/2">
              <h1 className="text-neutral-500 mt-4 text-[23px] capitalize px-1 font-extrabold">
                Plays Major Roles In
              </h1>
              <ul className="text-neutral-500 mt-1 text-[16px] px-1 font-normal">
            ...
            <p className="bio w-full md:w-1/2">
              <h1 className="text-neutral-500 mt-4 text-[23px] px-1 font-extrabold">
                Best Role In
              </h1>
              <p className="text-neutral-500 mt-2 text-[15px] px-1 font-normal">
