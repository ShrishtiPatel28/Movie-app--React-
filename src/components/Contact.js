  ...
  return (
    <div className="w-full h-auto text-white">
      <div className="relative w-full h-[60vh] bg-cover bg-center">
        ...
        ></div>
        <div className="absolute top-1/3 left-8 text-white ml-5">
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-wide leading-tight drop-shadow-lg">
            Contact Us
          </h1>
      ...
      <div className="w-[90%] sm:w-[80%] py-5 px-8 sm:px-12 ml-[60px]">
        <Button />

        {/* Contact Form Section */}
        <section className="py-6 px-6 border border-yellow-600 mb-6 transition">
          <h2 className="text-2xl sm:text-3xl font-black text-yellow-500 text-center mb-6">
            We'd Love to Hear from You!
          </h2>

          <form onSubmit={handleSubmit}>
            {/* Name Field */}
            <div className="mb-5 flex flex-col sm:flex-row justify-center items-center">
              <input
                type="text"
                id="name"
                name="name"
                value={formData.name}
                onChange={handleChange}
                className="w-full sm:w-1/2 px-4 py-2 border border-zinc-600 bg-transparent outline-none mb-4 sm:mb-0"
                placeholder="Your Name"
                required
              />
            </div>
            ...
            <div className="mb-5 flex flex-col sm:flex-row justify-center items-center">
              <input
                ...
                value={formData.email}
                onChange={handleChange}
                className="w-full sm:w-1/2 px-4 py-2 border border-zinc-600 outline-none bg-transparent mb-4 sm:mb-0"
                placeholder="Your Email"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="px-5 py-3 bg-yellow-500 font-extrabold text-black transition duration-300 ease-in-out w-full sm:w-auto mx-auto sm:mx-0"
            >
              Send Message
            </button>
          </form>
        ...
        <section className="bg-zinc-900 py-5 mt-8 text-center rounded-lg shadow-xl">
          ...
          <p className="text-sm sm:text-base text-yellow-500 hover:underline mb-4">
            contact@movieapp.com
          </p>
          <div className="mt-4 flex justify-center gap-8 text-2xl sm:text-3xl">
            <a
              href="https://www.facebook.com"
              className="text-yellow-500 hover:text-yellow-400 transition duration-200 ease-in-out"
              aria-label="Facebook"
