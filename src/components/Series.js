...
const Series = ({ series }) => {
  ...
  return (
    <div className="movies-container w-full min-h-screen p-4 pb-8 bg-black">
      {/* Top Bar */}
      <div className="top flex flex-col md:flex-row gap-4 md:gap-8 items-center md:items-start fixed top-0 bg-black w-full px-4 py-3 z-[900]">
        <Button />
        ...
        {filteredSeries.length > 0 ? (
          filteredSeries.map((movie) => (
            ...
            >
              ...
              <div className="flex flex-col pt-1">
                <h6 className="text-zinc-300 text-[12px] italic">
                  {movie.Year}
                </h6>
