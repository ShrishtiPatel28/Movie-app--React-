...
//   // Fetch movie data from the public folder
//   useEffect(() => {
...
//   // Fetch actor data from the public folder
//   useEffect(() => {
//     fetch(`${process.env.PUBLIC_URL}/Actors.json`)
//       .then((response) => response.json())
//       .then((data) => {
    ...
    <div className="w-full min-h-screen bg-black flex flex-col">
      <Routes>
        ...
        <Route
          ...
          element={<DetailsPeople actors={people} />}
        />
        <Route path="/trending" element={<Trending movies={trendingMovies} />} />
        <Route path="/popular" element={<Popular movies={popularMovies} />} />
      </Routes>
    </div>
  );
